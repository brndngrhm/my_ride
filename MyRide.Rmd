...
```{r}
#sometimes data is read in as multiple records, forming a list. in that case we need to bind them together to 1 data frame
...
fluidPage(
  fluidRow(column(6, highchartOutput("changepoint_plot")),
           column(6, highchartOutput("overlay_plot"))),
  fluidRow(column(6, highchartOutput("histogram")),
